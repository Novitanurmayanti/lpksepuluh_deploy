...
navbar = st.sidebar.selectbox(
    "Menu",
    ('Home', 'Kalkulator IMT', 'Rentang Kadar Gula Darah'),
)
...
if navbar == 'Rentang Kadar Gula Darah' :
    st.title('RENTANG KADAR GULA DARAH SESUAI USIA')
    search = st.text_input('  ', placeholder='cari sesuai kata kunci')
    st.image('katakuncigd.jpg')
    if st.button('CARI') :
        if search.lower() == '1' :
            col1, col2 = st.columns(2)
            with col1 :
                st.subheader('Tabel Rentang Kadar Gula Darah')
                st.image('rentang1.jpg', width=350)
            with col2 :
        ...
        if search.lower() == '2' :
            ...
            with col1 :
                ...
                st.image('rentang2.jpg', width=350)
            with col2 :
                st.subheader('Penjelasan')
        ...
        if search.lower() == '3' :
            ...
            with col1 :
                st.subheader('Tabel Rentang Gula Darah')
                st.image('rentang3.jpg', width=350)
            with col2 :
                st.subheader('Penjelasan')
        ...
        if search.lower() == '4' :
            ...
            with col1 :
                    st.subheader('Tabel Rentang Gula Darah')
                    st.image('rentang4.jpg', width=350)
            with col2 :
                    st.subheader('Penjelasan')
...
Kategori kadar gula rendah adalah saat angka pemeriksaannya kurang dari 100 mg/dL. Sudah memasuki kategori berbahaya jika angkanya di bawah 70 mg/dL. ''')
        if search.lower() == '5' :
            ...
            with col1 :
                st.subheader('Tabel Rentang Gula Darah')
                st.image('rentang5.jpg', width=350)
            with col2 :
                st.subheader('Penjelasan')
